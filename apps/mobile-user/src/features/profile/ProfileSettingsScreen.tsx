...
export function ProfileSettingsScreen() {
  ...
  const handleSave = async () => {
    ...
    if (!patch) {
      setFeedback({
        tone: 'success',
        message: t('profile.feedback.noChanges'),
      });
      return;
    }
    ...
    try {
      ...
      setFeedback({
        tone: 'success',
        message: t('profile.feedback.saved'),
      });
    } catch {
      setFeedback({
        tone: 'danger',
        message: t('profile.feedback.error'),
      });
    }
  };
        ...
        <View style={styles.section}>
          ...
          <View style={styles.placeholderGrid}>
            {placeholderCards.map((item) => (
              <Card key={item.key} style={styles.placeholderCard}>
                <View style={styles.placeholderIcon}>
                  <AppIcon name={item.icon} size={18} color={appTheme.colors.primary} />
                </View>
...
const placeholderCards = [
  {
    ...
    titleKey: 'profile.placeholders.emergencyTitle',
    bodyKey: 'profile.placeholders.emergencyBody',
  },
  {
    key: 'health',
    icon: 'heart-pulse',
    titleKey: 'profile.placeholders.healthTitle',
    bodyKey: 'profile.placeholders.healthBody',
  },
  {
    key: 'notifications',
    icon: 'bell-outline',
    titleKey: 'profile.placeholders.notificationsTitle',
    bodyKey: 'profile.placeholders.notificationsBody',
  },
  {
    key: 'privacy',
    icon: 'shield-lock-outline',
    titleKey: 'profile.placeholders.privacyTitle',
    bodyKey: 'profile.placeholders.privacyBody',
  },
  {
    key: 'agreements',
    icon: 'file-document-outline',
    titleKey: 'profile.placeholders.agreementsTitle',
    bodyKey: 'profile.placeholders.agreementsBody',
  },
  {
    key: 'help',
    icon: 'lifebuoy',
    titleKey: 'profile.placeholders.helpTitle',
    bodyKey: 'profile.placeholders.helpBody',
  },
] as const;
